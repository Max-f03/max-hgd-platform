...
export default function About() {
  return (
    <section id="about" className="py-16 sm:py-20 lg:py-24 px-4">
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 lg:gap-14 items-center">
        <Reveal variant="left">
        ...
        <Reveal variant="right" delay={100}>
          ...
          <div className="flex flex-col gap-3">
            ...
            <h2 className="text-xl sm:text-2xl lg:text-3xl font-medium text-neutral-900 leading-tight">
              Designer &amp; Developpeur passionne par l&apos;experience utilisateur
            </h2>
          </div>

          <div className="flex flex-col gap-4 sm:gap-5 text-neutral-600 leading-relaxed text-sm sm:text-base">
            <p>
